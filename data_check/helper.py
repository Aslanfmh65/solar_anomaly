...
#         return [cvscores, cm, rf_model,X_test,y_test,test_date]
    ...
    def model_predict(self,dataset, return_pred=False):
...
#         return((error/(len(data_true)-count))*100)
...
class visualizer:
    ...
    def raw_data_plot(self,dataset,title,save=False,resolution=None):
        # make the plot
    ...
    def pie_chart(self,dataset,title,save=False,resolution=None):
        ...
        plt.pie(value, labels=[k for k in counts], autopct=make_autopct(value),textprops={'fontsize': 14})
